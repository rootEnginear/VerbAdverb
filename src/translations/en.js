export default {
  ...
  'about.close': 'Close',
  // Restore Dialog
  'restore.title': 'Do you want to reset words?',
  'restore.content': `
    The word you've added will be <span class="red--text">deleted</span> and reset back to default words (you can still add them like before!).
  `,
  'restore.agree': 'Reset',
  ...
  // Settings
  'settings.soundTitle': 'Sound Effect',
